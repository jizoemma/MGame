...
try:
    ...
    #print "Run via:%s input_file_name model_name" %(sys.argv[0])
    #print "e.g. %s airport.csv app_airport.Airport" % sys.argv[0]
    #print "Note: input_file_name should be a path relative to where this script is."
    sys.exit()
